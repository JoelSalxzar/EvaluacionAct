      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-8 mt-lg-5 text-center">
            <h1 class="text-uppercase" data-aos="fade-up">BIENVENIDOS A Spin-Off!</h1>
            <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100"></p>
            <div data-aos="fade-up" data-aos-delay="100">
              <a href="./login-register-php-mysql-master/register.php" class="btn smoothscroll btn-primary mr-2 mb-2">Registrarse ahora</a>
              <a href="./login-register-php-mysql-master/login.php" class="btn smoothscroll btn-primary mr-2 mb-2">Inicio de Sesión</a>
            </div>
          </div>
